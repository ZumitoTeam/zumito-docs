...
- [Execution rules](/guides/command-execution-rules) – Control when commands can be executed with extensible rules.
- [Module lifecycle](/guides/module-lifecycle) – Understand the lifecycle hooks for modules.
