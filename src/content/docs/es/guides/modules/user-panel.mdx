...
Flujo de login basado en OAuth2 de Discord mediante el módulo compartido [`discord-auth`](/es/guides/modules/discord-auth):
...
Ambos módulos comparten la misma base de autenticación mediante [`discord-auth`](/es/guides/modules/discord-auth), con diferentes configuraciones:
